...
# === IDs das planilhas ===
planilhas_ids = {
        "Financeiro_contas_a_receber_JM": "108kIIp0_k5XFpjlasbwZbl-MCankKhy0PiV9kkEE8ns",
    "Financeiro_contas_a_pagar_JM": "1IKMBZ7vhay-kznsaOOadOYHM5O65SVadseGq0a0YTFk",
    "Financeiro_Completo_JM": "1YB1C0VVRp_9AuhDjEBfqmV7OTjce3Ood5ZlfPMwF69Q"
}
...
print("\n📋 Limpando: Financeiro_contas_a_receber_JM")
planilha_receber = client.open_by_key(planilhas_ids["Financeiro_contas_a_receber_JM"])
aba_receber = planilha_receber.sheet1
limpar_aba_completa(aba_receber, "Contas a Receber")

# 2. Limpa TUDO de Contas a Pagar
print("\n📋 Limpando: Financeiro_contas_a_pagar_JM")
planilha_pagar = client.open_by_key(planilhas_ids["Financeiro_contas_a_pagar_JM"])
...
print("\n📋 Limpando: Financeiro_Completo_JM (sheet1)")
planilha_completo = client.open_by_key(planilhas_ids["Financeiro_Completo_JM"])
...
print("\n📋 Limpando: Financeiro_Completo_JM (Dados_Pivotados)")
try:
